      ...
      <div className="bg-[#060B16] text-[#F5F5F7] min-h-screen font-sans selection:bg-[#C5A880] selection:text-black">
        ...
        <main className="pt-16 sm:pt-24 pb-24 px-4 sm:px-8 lg:px-16 max-w-6xl mx-auto w-full">
          ...
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-white/60 text-xs sm:text-sm lg:text-base max-w-3xl mx-auto leading-relaxed break-keep font-normal">
              변호사, 의사, 트레이너, 인테리어, 설비, 마사지 등 내 노하우를 24시간 파는 온라인 자동 세일즈 퍼널과 마스터 골조 프롬프트를 전격 탑재해 드립니다.
            </p>
          </div>

          {/* 럭셔리 대칭 2컬럼 레이아웃: 모바일은 1열 스택(grid-cols-1) / 데스크톱만 lg:grid-cols-12 */}
            ...
            <div className="lg:col-span-7 space-y-6">
              <div className="bg-[#101726] border border-white/10 rounded-3xl p-5 sm:p-8 shadow-xl">
                ...
                <div className="space-y-4">
                  <div className="p-4 sm:p-5 rounded-2xl bg-black/40 border border-white/10 hover:border-white/20 transition-colors">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="bg-[#C5A880] text-black font-extrabold text-[10px] px-2.5 py-0.5 rounded-full">Module 1</span>
                      <h3 className="font-bold text-white text-xs sm:text-sm">한국형 PLF 런치 이론 & 12인 거장 성공 사례</h3>
                    </div>
                  ...
                  <div className="p-4 sm:p-5 rounded-2xl bg-black/40 border border-white/10 hover:border-white/20 transition-colors">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="bg-[#C5A880] text-black font-extrabold text-[10px] px-2.5 py-0.5 rounded-full">Module 2</span>
                      <h3 className="font-bold text-white text-xs sm:text-sm">카메라 노출 없이 10분 만에 만드는 VSL 구현법</h3>
                    </div>
                    <p className="text-[11px] sm:text-xs text-white/50 leading-relaxed">
                  ...
                  <div className="p-4 sm:p-5 rounded-2xl bg-black/40 border border-white/10 hover:border-white/20 transition-colors">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      <span className="bg-[#C5A880] text-black font-extrabold text-[10px] px-2.5 py-0.5 rounded-full">Module 3</span>
                      <h3 className="font-bold text-white text-xs sm:text-sm">실습 숙제 템플릿 (Workbook) 워크시트</h3>
                    </div>
                    <p className="text-[11px] sm:text-xs text-white/50 leading-relaxed">
                  ...
                  <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-[#C5A880]/15 via-black to-black border-2 border-[#C5A880] shadow-lg">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-2 gap-2">
                      <div className="flex items-center gap-2">
                        <span className="bg-amber-400 text-black font-extrabold text-[10px] px-2.5 py-0.5 rounded-full shrink-0">핵심 보너스</span>
                        <h3 className="font-bold text-white text-xs sm:text-sm">초스피드 제작 마스터 골조 프롬프트</h3>
                      </div>
                      <span className="text-[11px] text-[#C5A880] font-bold shrink-0">정가 450,000원 ➔ 무료 증정</span>
                    </div>
            ...
            <div className="lg:col-span-5 lg:sticky lg:top-24 w-full">
              <div className="bg-[#101726] border-2 border-[#C5A880] rounded-3xl p-5 sm:p-6 shadow-2xl relative overflow-hidden">
                ...
                <div className="mb-5 border-b border-white/10 pb-3">
                  <h3 className="text-base sm:text-lg font-bold text-white mb-1">수강 플랜 선택 & 신청</h3>
                  <p className="text-[11px] text-white/50">원하시는 플랜을 선택하고 수강 신청을 진행하세요.</p>
                </div>
                ...
                {!orderComplete ? (
                  <form onSubmit={handleOrder} className="space-y-4">
                    ...
                    >
                      <div className="text-left">
                        <h4 className="font-bold text-white text-xs sm:text-sm mb-0.5">VOD 단독 수강권</h4>
                        <p className="text-[9px] text-white/40">VOD 4모듈 + 숙제 템플릿 열람권</p>
                      </div>
                      <div className="text-lg sm:text-xl font-extrabold text-[#C5A880] shrink-0">99,000원</div>
                    </div>
                    ...
                    >
                      <div className="text-left">
                        <h4 className="font-bold text-white text-xs sm:text-sm mb-0.5">풀 패키지 마스터 패스</h4>
                        <p className="text-[9px] text-white/40">VOD 4모듈 + 숙제 템플릿 + 골조 프롬프트</p>
                      </div>
                    ...
                    <div className="space-y-3.5 pt-3.5 border-t border-white/10">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input 
                            ...
                            placeholder="홍길동" 
                            className="w-full pl-10 pr-4 py-3 rounded-xl bg-[#060B16] border border-white/20 text-white text-xs sm:text-sm focus:outline-none focus:border-[#C5A880] transition-colors"
                          />
                        </div>
                      </div>

                      <div>
                        <label className="block text-[10px] font-semibold text-white/70 mb-1">이메일 주소 *</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-white/40">
                            <Mail size={15} />
                          </div>
                      ...
                      <div>
                        <label className="block text-[10px] font-semibold text-white/70 mb-1">휴대폰 번호 *</label>
                        <div className="relative">
                          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-white/40">
                            <Phone size={15} />
                          </div>
                  ...
                  <div className="text-center py-6">
                    ...
                    <h4 className="text-base sm:text-lg font-bold text-white mb-2">신청이 완료되었습니다!</h4>
