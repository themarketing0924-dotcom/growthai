      ...
      <div className="bg-[#060B16] text-[#F5F5F7] min-h-screen font-sans selection:bg-[#C5A880] selection:text-black">
        ...
        <main className="pt-36 pb-24 px-6 sm:px-10 md:px-12 lg:px-16 max-w-6xl mx-auto w-full">
          ...
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-[#C5A880]/10 text-[#C5A880] border border-[#C5A880]/30 shadow-[0_0_15px_rgba(197,168,128,0.15)] mb-6">
            ...
            <h1 className="text-2xl sm:text-4xl font-extrabold mb-5 leading-snug break-keep text-white tracking-tight">
              ...
              <span className="bg-gradient-to-r from-[#C5A880] via-[#DBC5A8] to-amber-200 bg-clip-text text-transparent block mt-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              {/* 시네마틱 프레임 비디오 플레이어 */}
              <div 
                className="relative rounded-3xl overflow-hidden border-2 border-[#C5A880]/45 bg-black shadow-[0_0_40px_rgba(197,168,128,0.15)] aspect-video flex flex-col items-center justify-center group cursor-pointer w-full transform hover:scale-[1.01] transition-all duration-300"
              ...
              >
                {!isPlaying ? (
                  <div className="relative z-10 text-center p-6 flex flex-col items-center">
                    <motion.div 
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-20 h-20 rounded-full bg-[#C5A880] text-black flex items-center justify-center mb-5 shadow-2xl shadow-[#C5A880]/40"
                    >
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-b from-[#101726] to-[#060B16] p-8 text-center">
                    <div className="w-16 h-16 rounded-full bg-[#C5A880]/20 border border-[#C5A880] flex items-center justify-center mb-4 animate-pulse">
                      <Play className="w-8 h-8 text-[#C5A880] fill-[#C5A880]" />
                    </div>
                ...
                <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-[10px] sm:text-xs text-white/60 bg-black/75 backdrop-blur-md px-4 py-2.5 rounded-xl border border-white/10">
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-[#C5A880]" /> 시청 시간: 10분 15초
                  </span>
                  <span className="text-[#C5A880] font-semibold">GrowthAI x 2026 Korean PLF</span>
                </div>
              </div>
            ...
            <div className="lg:col-span-5">
              {!showOffer ? (
                <div className="p-8 rounded-3xl bg-[#101726] border border-dashed border-[#C5A880]/40 text-center shadow-lg">
                  <p className="text-xs sm:text-sm text-white/70 mb-4 flex items-center justify-center gap-2">
                    <Clock className="w-4 h-4 text-[#C5A880] animate-spin" />
                    VOD 마스터클래스 & 프롬프트 오퍼 신청 버튼이 <span className="text-[#C5A880] font-bold">{timerSeconds}초</span> 후 활성화됩니다.
                  </p>
                  <div className="w-full bg-white/10 h-2 rounded-full overflow-hidden max-w-xs mx-auto">
                    <div 
                      className="bg-[#C5A880] h-full transition-all duration-1000 ease-linear"
                ...
                <motion.div
                  ...
                  className="p-6 sm:p-8 rounded-3xl bg-[#101726] border-2 border-[#C5A880] text-center shadow-2xl relative overflow-hidden backdrop-blur-xl"
                >
                  <div className="absolute top-0 right-0 bg-[#C5A880] text-black font-extrabold text-[10px] px-3.5 py-1.5 rounded-bl-xl uppercase tracking-wider">
                    특별 오퍼 공개
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-4 rounded-xl bg-[#C5A880] hover:bg-[#d9b85c] text-black font-extrabold text-xs sm:text-sm transition duration-200 shadow-xl shadow-[#C5A880]/25 flex items-center justify-center gap-2 cursor-pointer border-none"
                  >
                    <BookOpen size={16} />
                  ...
                  <div className="mt-5 flex items-center justify-center gap-2.5 text-[10px] text-white/50">
                    <span className="flex items-center gap-1">
                      <ShieldCheck size={12} className="text-[#C5A880]" /> 30일 조건부 실행 보증
                    </span>
                    <span>•</span>
                    <span className="flex items-center gap-1">
                      <Star size={12} className="text-[#C5A880]" /> 선착순 가입 진행
                    </span>
                  </div>
                </motion.div>
              )}
