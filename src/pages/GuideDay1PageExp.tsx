    ...
    <div className="min-h-screen bg-[#0A0D14] text-white pt-24 pb-20 px-4 sm:px-6">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-6">
          <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold bg-[#C9A84C]/10 text-[#C9A84C] border border-[#C9A84C]/30">
        ...
        {/* 메인 비디오 타이틀 */}
        <h1 className="text-2xl sm:text-4xl font-extrabold text-center mb-4 leading-tight break-keep">
        ...
        <p className="text-center text-white/60 text-sm sm:text-base max-w-2xl mx-auto mb-8">
          단순히 글귀만 고치는 것은 소용없습니다. 내 서비스명만 입력하면 3시간 만에 완성되는 한국형 3단계 동영상 런치 퍼널의 비밀.
        </p>

        {/* 비디오 프레임 */}
        <div 
          className="relative rounded-2xl overflow-hidden border border-[#C9A84C]/30 bg-black/80 shadow-2xl mb-8 aspect-video flex flex-col items-center justify-center group cursor-pointer"
        ...
        >
          {!isPlaying ? (
            <div className="relative z-10 text-center p-6 flex flex-col items-center">
              <motion.div 
                ...
                whileTap={{ scale: 0.95 }}
                className="w-20 h-20 rounded-full bg-[#C9A84C] text-black flex items-center justify-center mb-4 shadow-lg shadow-[#C9A84C]/30"
              >
            ...
            <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-b from-[#141923] to-[#0A0D14] p-8 text-center">
          ...
          <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between text-xs text-white/60 bg-black/60 backdrop-blur-sm px-4 py-2 rounded-lg border border-white/10">
            <span className="flex items-center gap-1.5">
              <Clock className="w-3.5 h-3.5 text-[#C9A84C]" /> 시청 시간: 10분 15초
            </span>
            <span className="text-[#C9A84C]">GrowthAI x 2026 Korean PLF</span>
          </div>
        </div>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 mb-10">
          ...
          <ul className="space-y-4 text-sm text-white/80">
            <li className="flex items-start gap-3">
              ...
              <div>
                <strong className="text-white">1. 오픈 전 고객의 마음을 여는 문자/알림톡 3단계 예열법</strong>
                <p className="text-xs text-white/50 mt-0.5">이메일 오픈율 20%의 한계를 깨고, 90% 열람 문자 수집 후 영상으로 끌어당기는 심리 배관</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-[#C9A84C] shrink-0 mt-0.5" />
              <div>
                ...
                <p className="text-xs text-white/50 mt-0.5">얼굴 노출 부담 없이 한국 수강생들이 열광하는 타격형 스토리 비유 공식</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle2 className="w-5 h-5 text-[#C9A84C] shrink-0 mt-0.5" />
              <div>
                ...
                <p className="text-xs text-white/50 mt-0.5">프롬프트 공부 없이 내 상품 설명 1줄만 넣으면 3분 만에 세일즈 스크립트 자동 완출</p>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="text-center">
          {!showOffer ? (
            <div className="p-6 rounded-2xl bg-white/5 border border-dashed border-[#C9A84C]/40 text-center">
              <p className="text-sm text-white/70 mb-2 flex items-center justify-center gap-2">
            ...
            <motion.div
              ...
              className="p-8 rounded-2xl bg-gradient-to-b from-[#C9A84C]/15 via-black to-black border-2 border-[#C9A84C] text-center shadow-2xl relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 bg-[#C9A84C] text-black font-bold text-xs px-4 py-1 rounded-bl-lg">
                한정 오퍼 오픈
              </div>
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#C9A84C] hover:bg-[#d9b85c] text-black font-bold text-base transition-all duration-200 shadow-xl shadow-[#C9A84C]/25 flex items-center justify-center gap-2 mx-auto"
              >
